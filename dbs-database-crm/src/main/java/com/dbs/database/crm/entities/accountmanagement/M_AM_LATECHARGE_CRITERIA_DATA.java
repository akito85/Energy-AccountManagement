...
@Entity
@Data
@Table(name = "M_AM_LATECHARGE_CRITERIA_DATA")
public class M_AM_LATECHARGE_CRITERIA_DATA extends BaseEntities implements Serializable {

    @Id
    @Column(name = "ID",nullable = false, updatable = false)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator = "M_AM_LATECHARGE_CRITERIA_DATA_SEQ")
    @SequenceGenerator(sequenceName = "M_AM_LATECHARGE_CRITERIA_DATA_SEQ", allocationSize = 1, name = "M_AM_LATECHARGE_CRITERIA_DATA_SEQ")
    private Integer id;
