...
@Entity
@Data
@Table(name = "VW_AM_SRC_DIST")
public class VW_AM_SRC_DIST extends BaseEntities implements Serializable {
    ...
    private List<VW_AM_SRC_DIST_DTL> srcDistDtl;
