...
@Entity
@Table(name = "R_PAY_RECEIPT_RECONCILE")
@Data
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
public class R_PAY_RECEIPT_RECONCILE extends DefaultBaseEntities implements Serializable {
    ...
    @Column(name = "RECEIPT_RECONCILE_ID", nullable = false, updatable = false)
