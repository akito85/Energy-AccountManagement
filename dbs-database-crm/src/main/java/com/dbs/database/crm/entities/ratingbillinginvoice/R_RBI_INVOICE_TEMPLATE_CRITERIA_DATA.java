...
@Data
@Entity
@Table(name = "R_RBI_INVOICE_TEMPLATE_CRITERIA_DATA")
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
public class R_RBI_INVOICE_TEMPLATE_CRITERIA_DATA extends DefaultBaseEntities implements Serializable {

    private static final long serialVersionUID = 5532799336125784439L;

    @Id
    @Column(name = "ID", nullable = false, updatable = false)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "R_RBI_INVOICE_TEMPLATE_CRITERIA_DATA_SEQ")
    @SequenceGenerator(sequenceName = "R_RBI_INVOICE_TEMPLATE_CRITERIA_DATA_SEQ", allocationSize = 1, name = "R_RBI_INVOICE_TEMPLATE_CRITERIA_DATA_SEQ")
    private Integer id;
